    ...
    <el-dialog
      ...
      <el-form v-model="form" style="text-align: left" ref="dataForm">
        ...
        <el-form-item label="Cover" :label-width="formLabelWidth" prop="cover">
          <el-input v-model="form.cover" autocomplete="off" placeholder="Photo URL"></el-input>
        ...
        <el-form-item label="Category" :label-width="formLabelWidth" prop="cid">
          <el-select v-model="form.category.id" placeholder="Please choose the category">
            <el-option label="Literature" value="1"></el-option>
            <el-option label="Pop Culture" value="2"></el-option>
            ...
            <el-option label="Tech" value="6"></el-option>
          </el-select>
        </el-form-item>
